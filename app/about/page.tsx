...
export default async function AboutPage() {
  ...
  return (
    <main>
      ...
      />
      <Navbar />
      <section className="grid min-h-[80svh] items-center gap-10 px-4 pb-16 pt-32 sm:px-6 lg:grid-cols-2 lg:px-8">
        <div className="mx-auto w-full max-w-7xl lg:col-span-2 lg:grid lg:grid-cols-2 lg:items-center lg:gap-10">
