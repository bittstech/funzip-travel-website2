  ...
  return (
    <section id="packages" className="relative overflow-hidden py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          {packages.length === 0 ? (
            <div className="flex min-h-[300px] items-center justify-center rounded-3xl border border-dashed border-border bg-card/50">
              ...
              {packages.map((pkg, i) => (
                ...
                >
                  ...
                  <div className="flex min-w-0 flex-1 flex-col p-5 sm:p-6">
                    <h3 className="line-clamp-2 font-heading text-2xl font-semibold leading-tight">
                      {pkg.title}
                    </h3>
                    ...
                    <div className="mt-auto flex flex-col items-stretch justify-end gap-3 pt-6 min-[380px]:flex-row">
                      <Link
